...
passwordCheck proc												
    ...
    lea edi, [password]                ; Load the address of password into edi

    compare_loop:
    ; Compare characters
        mov al, [esi]       ; Load a character from passwordInputBuffer into al
        mov bl, [edi]       ; Load a character from password into bl
        ...
        inc edi             ; Move to the next character in password
